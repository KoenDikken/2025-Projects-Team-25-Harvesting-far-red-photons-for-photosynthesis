...
with open('Emission_all_plants_rt.csv', newline='') as csvfile:
...
plt.plot(wv_0, emAT, alpha = 0.7, color = 'pink', label = 'AT')
plt.plot(wv_0, emFA, alpha = 0.7, color = 'orange', label = 'FA')

plt.xlabel('Wavelength (nm)')
plt.ylabel('a.u.')
plt.title('Emission all plants room temperature')
plt.legend()
plt.savefig('Emission_all_plants_rt.png')
plt.show()