...
wavelength2, intensity2 = read_csv('normaliseers/FLUOROLOGDATA-Sheet1.csv', 0, 11)
...
plt.plot(wavelength2, intensity22, label='Rt emission AT')
plt.xlabel('Wavelength (nm)')
plt.ylabel(' Intensity(A.U.)')
plt.xlim(left= 600, right=850)
plt.title('Room temperature emission CE/AT')
plt.legend()
