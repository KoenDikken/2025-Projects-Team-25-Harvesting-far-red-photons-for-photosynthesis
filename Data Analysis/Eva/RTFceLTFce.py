...
wavelength2, intensity2 = read_csv('normaliseers/FLUOROLOGDATA-Sheet1.csv', 0, 8)
...
intensity22 = normalize_max(intensity2)


# Plotten
plt.plot(wavelength1, intensity11, label=' LT Emission CE')
plt.plot(wavelength2, intensity22, label='RT emission CE')
plt.xlabel('Wavelength (nm)')
plt.ylabel(' Intensity(A.U.)')
plt.title('Room Temperature vs Low Temperature emission CE')
