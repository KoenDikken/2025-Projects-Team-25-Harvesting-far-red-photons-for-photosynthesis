...
def normalize_max2(data):
    ...
    return [val / max_val for val in data]
# Data inlezen
wavelength1, intensity1 = read_csv('normaliseers\Plantsthylakoids.csv', 0, 15)
wavelength2, intensity2 = read_csv('normaliseers\Plantsthylakoids.csv', 0, 5)

# Normaliseren
intensity11 = normalize_max2(intensity1)
intensity22 = normalize_max1(intensity2)
...
if wavelength1 != wavelength2:
    ...
    # Voor nu nemen we alleen het overlappende bereik
